...
/*if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['Номер_договора'])) {
  $Номер_договора = $users->selectSERContract($value->Номер_договора, $_POST);
}*/
 ...
 ?>
      <div class="card ">
        <div class="card-header">
          <h3><i class="fas fa-users mr-2"></i>Договор на поставку услуг <span class="float-right">Welcome! <strong>
...
if ( Session::get("roleid") == '1') {   ?>                 
  ...
  <a class="nav-link" href="contractAdd.php"><i class="fas fa-user-plus mr-2"></i>Оформить новый договор </span></a>
  <?php } ?>
          ...
          <table id="example" class="table table-striped table-bordered" style="width:100%">
                  ...
                  <tbody>
                    <?php
                      ...
                      $allUser = $users->selectAllContract();
                      ...
                      >
                        ...
                        <td>
                          ...
                          <?php if ( Session::get("roleid") == '1') {?>
                            ...
                            <a class="btn btn-success btn-sm " href="contractSER.php?Номер_договора=<?php echo $value->Номер_договора;?>">Услуги</a>
