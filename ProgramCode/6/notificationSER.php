 ...
 ?>
      <div class="card ">
        <div class="card-header">
          <h3><i class="fas fa-users mr-2"></i>Показания в извещении <span class="float-right">Welcome! <strong>
...
if (isset($username)) {
 ...
 ?>
  ...
  <!--<a class="nav-link" href="#.php"><i class="fas fa-user-plus mr-2"></i>Добавить новую у"№"№"№№слугу </span></a> -->
          ...
          <table id="example" class="table table-striped table-bordered" style="width:100%">
                  <thead>
                    ...
                    <?php
                     ...
                     <th  class="text-center">ID</th>
                      ...
                      <th  class="text-center">Единица_хранения</th>
                      <th  class="text-center">Тариф</th>
                      <th  class="text-center">Количество</th>
                      <th  class="text-center">Итого сумма</th>
                      <th  class="text-center">Код извещения</th>
                  ...
                  <tbody>
                    <?php
                      ...
                      $allUser = $users->selectSERNotification();
