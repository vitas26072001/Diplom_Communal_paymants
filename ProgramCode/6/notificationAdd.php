...
<?php
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['NotificationAdd'])) {

  $indicationAdd = $users->addNewNotificationByAdmin($_POST);
}
...
if (isset($indicationAdd)) {
 ...
 <div class="card ">
   <div class="card-header">
          <h3 class='text-center'>Создать новое извещение</h3>
        </div>
        <div class="cad-body">
            ...
            <form class="" action="" method="post">
                ...
                <div class="form-group">
                  <button type="submit" name="NotificationAdd" class="btn btn-success">Добавить</button>
                  <a href="notification.php" class="btn btn-primary">Назад</a>
                </div>
